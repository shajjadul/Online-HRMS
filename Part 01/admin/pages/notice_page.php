...
<div style="width:1000px; min-height:500px;">
      ...
      <div style=" text-align:right; margin-right:50px; padding-top:5px; font-family: Verdana, Geneva, sans-serif;">
       <a href="notice_list.php?ac=notice">View notice list</a>
      </div>

  <div style="width:990px; padding:0px 5px 10px 5px;">
  
<form id='contactus' action='notice_page_insert.php' method='post' accept-charset='UTF-8'>
<fieldset >
...
<div class='container'>
    ...
    <input type='text' name='noticeno' id='noticeno' value='' maxlength="100" /><br/>
...
<div class='container'>
    ...
    <input type='text' name='noticeheadline' id='noticeheadline' value=''/><br/>
...
<div class='container'>
    ...
    <input type='text' name='submittedby' id='submittedby' placeholder="name" value='' maxlength="100" /><br/>
    <span id='contactus_submittedby_errorloc' class='error'></span>
</div>


<div class='container'>
    <input type='text' name='designation' id='designation' placeholder="designation" value='' maxlength="100" /><br/>
