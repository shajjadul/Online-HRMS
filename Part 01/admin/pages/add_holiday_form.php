...
<body>
<!-- Form Code Start -->
<form id='contactus' action='add_holiday_insert.php' method='post' accept-charset='UTF-8'>
<fieldset >
<legend>Add Holiday Form</legend>
...
<div class='container'>
    ...
    <input type='text' name='HoliDayDescription' id='HoliDayDescription' value='' maxlength="100" /><br/>
    <span id='contactus_HoliDayDescription_errorloc' class='error'></span>
</div>

<div class='container'>
    <label for='HoliDayDate' >Holiday Date: </label><br/>
    <input type='date' name='HoliDayDate' placeholder="yyyy-mm-dd" id='HoliDayDate' value='' maxlength="50" /><br/>
