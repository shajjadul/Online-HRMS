...
<?php
	...
	$result=mysql_query("select * from add_employee where status='0' or status='1' ORDER BY emp_joiningdate ASC");
...
<div align="center" style="width:1000px; min-height:600px;">
    <div class="Table">
        <div class="Title">
            Employee List of Evolution Group
        </div>
    <div class="Heading">
       <div>    
